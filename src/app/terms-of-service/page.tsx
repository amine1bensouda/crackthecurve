  ...
  return (
    <div className="min-h-screen bg-[#fdfbf7]">
      <div className="container mx-auto max-w-4xl px-4 py-12 md:py-20">
        <h1 className="font-display mb-8 text-4xl font-semibold text-[#2c3c5e] md:text-5xl">Terms of Service</h1>
        ...
        <div className="max-w-none space-y-6 text-[#6b7180]">
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">2. Use License</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">3. User Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">4. Acceptable Use</h2>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">5. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">6. Quiz Content and Results</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">7. Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">8. Limitations</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">9. Links to Other Websites</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">10. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">11. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-display mb-4 mt-8 text-2xl font-semibold text-[#2c3c5e]">12. Contact Information</h2>
