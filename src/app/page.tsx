...
export default async function HomePage() {
  ...
  return (
    <div className="w-full">
            ...
            <div className="max-w-4xl mx-auto mb-8 sm:mb-10">
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 lg:p-10 shadow-lg">
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed">
                  <span className="font-semibold text-gray-900">Sona Prep</span> is a free online platform offering high-quality math practice problems for standardized exams in the United States. Improve your skills and prepare for any major math test with{' '}
      ...
      {/* How Sona Prep Helps You Score Higher Section */}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-cyan-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-4 sm:mb-6 px-1">
                How Sona Prep Helps You Score Higher
              </h2>
            </div>
      ...
      {/* Why Students Use Sona Prep Section */}
